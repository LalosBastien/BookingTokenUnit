...
var RES = function () {
	var CONTRACT_ADDRESS = '0x8f0483125fcb9aaaefa9209d8e9d7b9c8b9fb90f';
	var ABI_FILE_PATH = process.cwd() + '/../build/contracts/RES.json';
  ...
  */
	...
	return new Promise(function (resolve, reject) {
		new Contract().withAddress(CONTRACT_ADDRESS).withABI(ABI_FILE_PATH).then(function (_contract) {
			contract = _contract;
